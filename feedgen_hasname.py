...
class FeedgenHasname(object):
    ...
    def __init__(self):
        ...
        self.app.route('/dcard/top', callback=self.dcardtop)
        ...
        self.app.route('/shopee/<keyword>', callback=self.shopee)
        self.app.route('/youtube/<keyword>', callback=self.youtube)
    ...
    def shopee(self, keyword):
        ...
        for item in body['items']:
            ...
            futures.append(
                session.get(itemapi_url, headers={'User-agent': self.user_agent}, timeout=5)
            )
